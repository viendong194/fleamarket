...
import { getProduct, like, follow } from './../redux/actions/actions';
import PropTypes from 'prop-types';
import FollowButton from './FollowButton';

const mapStateToProps = (state) => {
  return {
    _product: state.products.product,
...
class ProductView extends Component {
  ...
  render() {
    const { text, claps, title, feature_img, author } = this.props._product;
              ...
              <div className="post-stats clearfix">
                <div className="pull-left">
                  <div className="like-button-wrapper">
                    <button
                      onClick={() => this.props.clap(this.props._product._id)}
...
/*function mapStateToProps (state, ownProps) {
    ...
    let product = {}
    state.products.products.forEach((_product)=>{
        if(product_id == _product._id) {
            product = _product
        }
    })
    return { product }
